...
namespace Scene {
    ...
    private:
        ...
        void getKeypointIndexes(const ImageContainer &leftImageContainer, const size_t &rightImageIndex,
                                std::vector<size_t> &leftKeypointIndexes, std::vector<size_t> &rightKeypointIndexes);
    ...
    public:
        ...
        SceneSequence generateSequence(std::filesystem::path folderpath, std::filesystem::path matchOutputDirectory);
    };
}
